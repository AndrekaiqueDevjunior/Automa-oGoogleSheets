...
function mostrarMensagemHTML(numeroProposta, linkPDF) {
  var html = `
    ...
    <body>
      ...
      <p>Número da proposta: <strong>${numeroProposta}</strong></p>
      <p>
  ...
  SpreadsheetApp.getUi().showModalDialog(HtmlService.createHtmlOutput(html), 'Proposta Gerada');
}
...
function gerarPDF(abaProposta, numeroProposta) {
  ...
  var destinatario = 'andrekaidellisola@gmail.com';
